...
namespace EEGPatternizer
{
    ...
    {      
        ...
        public Form1()        
        {
            ...
            b_dwt = new Bitmap(ImgW*4, ImgH);
            b_d4 = new Bitmap(ImgW*4, ImgH);
           ...
           for (int l = 0; l < SigSize; l++)
            {
                lpt_raw.X = lpt_fft.X = lpt_dwt.X = lpt_d4.X = l;
                    ...
                    s_dwt = signaldwt[l] * Factor_DWT;
                    s_d4 = signald4[l] * Factor_DWT;
/*
                if (l < half) { 
...
//==============================================================================================
        ...
        private void ReadEEGFile(string fname)
        {
            ...
            foreach (String s in lines)
            {
                ...
                Y = Convert.ToDouble(data_chunk[1]);
                fdata.Add(Convert.ToInt32(Y));
            }
